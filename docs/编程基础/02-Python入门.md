...
| --- | --- | --- |
| **符号** | **说明** | **示例** |
| `**<font style="color:#DF2A3F;">%s</font>**` | **<font style="color:#DF2A3F;">字符串（调用 str ()，通用首选）</font>** | `'%s' % 123`<br/> → `"123"` |
| `**<font style="color:#DF2A3F;">%d</font>**` | **<font style="color:#DF2A3F;">十进制整数（有符号）</font>** | `'%d' % -20`<br/> → `"-20"` |
| `**<font style="color:#DF2A3F;">%f</font>**` | **<font style="color:#DF2A3F;">浮点数（默认保留 6 位小数）</font>** | `'%f' % 3.14`<br/> → `"3.140000"` |
...
| **函数** | **作用** | **示例** | **备注** |
| --- | --- | --- | --- |
| `**<font style="color:#DF2A3F;">int(x, base=10)</font>**` | **<font style="color:#DF2A3F;">转为整数</font>** | `int("66")`<br/> → `66`<br/>`int("1010",2)`<br/> → `10` | base 指定进制 (2~36)；字符串必须是合法数字 |
| `**<font style="color:#DF2A3F;">float(x)</font>**` | **<font style="color:#DF2A3F;">转为浮点型</font>** | `float("3.14")`<br/> → `3.14` | 支持整数、数字字符串 |
| `bool(x)` | 转为布尔值 | `bool(0)`<br/>→`False`<br/>`bool(5)`<br/>→`True` | 空 / 0/None→False；其余大多 True |
| `**<font style="color:#DF2A3F;">str(x)</font>**` | **<font style="color:#DF2A3F;">转为字符串</font>** | `str(123)`<br/> → `"123"` | 所有对象都可以转字符串 |
| `complex(real,imag)` | 转为复数 | `complex(2,3)`<br/> → `(2+3j)` | `complex("5+2j")`<br/> 也支持字符串 |
| **<font style="color:#DF2A3F;">eval(expr)</font>** | <font style="color:#DF2A3F;">执行字符串内的表达式，</font>**<font style="color:#DF2A3F;background-color:rgba(0, 0, 0, 0);">自动推导结果类型</font>** | `<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">eval("1+2")</font>` → `<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">3</font>`<br/>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">eval("[1,2,3]")</font>` → `<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">[1,2,3]</font>`<br/>`<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">eval("3.14")</font>` → `<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">3.14</font>` | 只能执行**<font style="color:rgb(0, 0, 0);background-color:rgba(0, 0, 0, 0);">表达式</font>**，不能执行语句；风险极高 |
...
| **函数** | **作用** | **示例** | **备注** |
| --- | --- | --- | --- |
| `**<font style="color:#DF2A3F;">list(x)</font>**` | **<font style="color:#DF2A3F;">转为列表</font>** | `list((1,2))`<br/> → `[1,2]` | 接收可迭代对象：**<font style="color:#DF2A3F;">元组、字符串、集合等</font>** |
| `**<font style="color:#DF2A3F;">tuple(x)</font>**` | **<font style="color:#DF2A3F;">转为元组</font>** | `tuple([1,2])`<br/> → `(1,2)` | **<font style="color:#DF2A3F;">不可变序列</font>** |
